...
const sessdata = config.SESSION_ID.split("RGR_MD=")[1];
...
console.log("Connecting RGR MD Bot.....🔥");
...
console.log('RGR MD Bot connected to whatsapp ✅')

let up = `*Connecting RGR-MD Whatsapp mini Bot ...💾*


*𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏 𝐂𝐇𝐀𝐍𝐍𝐄𝐋*
*╭┈───────────╴╴╴•⟢*
*│https://whatsapp.com/channel/0029Vb6I2IOCHDyfoPCOW247*
*┊* 
*┊* *`මේකට සෙට්වෙලා ඉන්න මම දැන්ම චැනල් එකක් හදන්නෙ නෑ`*
*╰┈───────────╴╴╴•⟢*
*𝐂𝐎𝐍𝐓𝐀𝐂𝐓 OF THE BOT OWNER*
*╔═════════════════════════❍*
*║*
*║wa.me/+94710632039?text=Hi+RGR+bot+Owner☺️*
*║*
*╚═════════════════════════════❍*

`;

conn.sendMessage(conn.user.id,{ image: { url: `https://i.ibb.co/PGk9tMKh/Manul-Ofc-X.jpg` }, caption: up })
...
//================ownerreact==============
if(senderNumber.includes("94710632039")){
if(isReact) return
m.react("👨‍💻")
}
